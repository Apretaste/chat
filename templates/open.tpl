	...
	<table width="100%" cellpadding="3">
		{foreach item=item from=$notes}
			<tr>
				...
				<td align="right">
					{button href="CHAT @{$item->username}" caption="Enviar nota" size="small" body="Escriba en el asunto el texto a enviar a continuacion del @username" desc="Escriba el texto a enviar" popup="true" wait="false"}
...
{else}
	...
	{space5}
	<center>
		{button href="CHAT" desc="Escriba el @username de su amigo seguido del texto a enviar. Por ejemplo: @alfredo Hola como anda todo?" caption="Primera Nota" popup="true" wait="false"}
	</center>
{/if}
